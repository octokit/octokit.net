...
namespace Octokit
{
    ...
    public class RepositoryHook
    {
        ...
        public RepositoryHook(long id, string url, string testUrl, string pingUrl, DateTimeOffset createdAt, DateTimeOffset updatedAt, string name, IReadOnlyList<string> events, bool active, IReadOnlyDictionary<string, string> config)
        {
            Url = url;
            TestUrl = testUrl;
            PingUrl = pingUrl;
