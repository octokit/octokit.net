...
namespace Octokit
{
    public interface IOrganizationHooksClient
    {
        ...
        /// <returns></returns>
        Task<IReadOnlyList<OrganizationHook>> GetAll(string organizationName);
        ...
        Task<OrganizationHook> Get(string organizationName, int hookId);
        ...
        /// <returns></returns>
        Task<OrganizationHook> Create(string organizationName, NewOrganizationHook hook);
        ...
        /// <returns></returns>
        Task<OrganizationHook> Edit(string organizationName, int hookId, EditOrganizationHook hook);
        ...
        /// <returns></returns>
        Task Ping(string organizationName, int hookId);
        ...
        /// <returns></returns>
        Task Delete(string organizationName, int hookId);
    }
}
