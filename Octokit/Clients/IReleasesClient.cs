...
namespace Octokit
{
    ...
    public interface IReleasesClient
    {
        ...
        /// <param name="owner">The repository's owner</param>
        /// <param name="name">The repository's name</param>
        /// <param name="releaseAssetId">The id of the <see cref="ReleaseAsset"/>.</param>
        Task DeleteAsset(string owner, string name, int releaseAssetId);
        ...
        /// <param name="repositoryId">The Id of the repository</param>
        /// <param name="releaseAssetId">The id of the <see cref="ReleaseAsset"/>.</param>
        Task DeleteAsset(long repositoryId, int releaseAssetId);
    }
}
