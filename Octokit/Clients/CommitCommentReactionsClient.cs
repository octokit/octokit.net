...
namespace Octokit
{
    ...
    public class CommitCommentReactionsClient : ApiClient, ICommitCommentReactionsClient
    {
        ...
        public Task Delete(string owner, string name, int number, int reaction)
        {
            ...
            return ApiConnection.Delete(ApiUrls.CommitCommentReaction(owner, name, number, reaction));
        }
        ...
        {
            return ApiConnection.Delete(ApiUrls.CommitCommentReaction(repositoryId, number, reaction));
        }
    }
}
