...
namespace Octokit
{
    ...
    public class OrganizationsClient : ApiClient, IOrganizationsClient
    {
        ...
        public OrganizationsClient(IApiConnection apiConnection) : base(apiConnection)
        {
            ...
            OutsideCollaborators = new OrganizationOutsideCollaboratorsClient(apiConnection);
        }
        ...
        /// </summary>
        public IOrganizationOutsideCollaboratorsClient OutsideCollaborators { get; private set; }
