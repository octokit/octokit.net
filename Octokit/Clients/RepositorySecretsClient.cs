...
namespace Octokit
{
    public class RepositorySecretsClient : ApiClient, IRepositorySecretsClient
    {
		...
		/// </summary>
		/// <remarks>
		/// See the <a href="https://docs.github.com/rest/actions/secrets/#get-a-repository-public-key">API documentation</a> for more information.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// See the <a href="https://docs.github.com/rest/actions/secrets/list-repository-secrets">API documentation</a> for more information.
		/// </remarks>
		/// <param name="owner">The owner of the repository</param>
		/// <param name="repoName">The name of the repository</param>
		/// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
		...
		/// </summary>
		/// <remarks>
		/// See the <a href="https://docs.github.com/rest/actions/secrets/#get-a-repository-secret">API documentation</a> for more information.
		/// </remarks>
		/// <param name="owner">The owner of the repository</param>
		/// <param name="repoName">The name of the repository</param>
		...
		/// </summary>
		/// <remarks>
		/// See the <a href="https://docs.github.com/rest/actions/secrets/#create-or-update-a-repository-secret">API documentation</a> for more information.
		/// </remarks>
		/// <param name="owner">The owner of the repository</param>
		/// <param name="repoName">The name of the repository</param>
		/// <param name="secretName">The name of the secret</param>
		...
		/// </summary>
		/// <remarks>
		/// See the <a href="https://docs.github.com/rest/actions/secrets/#delete-a-repository-secret">API documentation</a> for more information.
		/// </remarks>
		/// <param name="owner">The owner of the repository</param>
		/// <param name="repoName">The name of the repository</param>
		/// <param name="secretName">The name of the secret</param>
