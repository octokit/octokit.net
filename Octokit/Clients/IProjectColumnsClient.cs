...
namespace Octokit
{
    ...
    public interface IProjectColumnsClient
    {
        ...
        Task<IReadOnlyList<ProjectColumn>> GetAll(long projectId);
        ...
        Task<IReadOnlyList<ProjectColumn>> GetAll(long projectId, ApiOptions options);
        ...
        Task<ProjectColumn> Create(long projectId, NewProjectColumn newProjectColumn);
