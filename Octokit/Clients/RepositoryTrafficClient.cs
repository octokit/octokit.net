...
namespace Octokit
{
    public class RepositoryTrafficClient : ApiClient, IRepositoryTrafficClient
    {
        ...
        {
            return ApiConnection.Get<IReadOnlyList<RepositoryTrafficPath>>(ApiUrls.RepositoryTrafficPaths(repositoryId), null, AcceptHeaders.RepositoryTrafficApiPreview);
        }
        ...
        {
            return ApiConnection.Get<IReadOnlyList<RepositoryTrafficPath>>(ApiUrls.RepositoryTrafficPaths(owner, name), null, AcceptHeaders.RepositoryTrafficApiPreview);
        }
        ...
        {
            return ApiConnection.Get<IReadOnlyList<RepositoryTrafficReferrer>>(ApiUrls.RepositoryTrafficReferrers(repositoryId), null, AcceptHeaders.RepositoryTrafficApiPreview);
        }
        ...
        {
            return ApiConnection.Get<IReadOnlyList<RepositoryTrafficReferrer>>(ApiUrls.RepositoryTrafficReferrers(owner, name), null, AcceptHeaders.RepositoryTrafficApiPreview);
        }
