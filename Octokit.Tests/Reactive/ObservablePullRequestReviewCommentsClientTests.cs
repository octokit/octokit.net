    ...
    public class ObservablePullRequestReviewCommentsClientTests
    {
        ...
        public class TheGetForPullRequestMethod
        {
            ...
            public async Task RequestsCorrectUrlMulti()
            {
                ...
                var gitHubClient = Substitute.For<IGitHubClient>();
                gitHubClient.Connection.Get<List<PullRequestReviewComment>>(firstPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"))
                    .Returns(Task.Factory.StartNew<IApiResponse<List<PullRequestReviewComment>>>(() => firstPageResponse));
                gitHubClient.Connection.Get<List<PullRequestReviewComment>>(secondPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"))
                    .Returns(Task.Factory.StartNew<IApiResponse<List<PullRequestReviewComment>>>(() => secondPageResponse));
                gitHubClient.Connection.Get<List<PullRequestReviewComment>>(thirdPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"))
                ...
                gitHubClient.Connection.Received(1).Get<List<PullRequestReviewComment>>(firstPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"));
                gitHubClient.Connection.Received(1).Get<List<PullRequestReviewComment>>(secondPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"));
                gitHubClient.Connection.Received(1).Get<List<PullRequestReviewComment>>(thirdPageUrl, Args.EmptyDictionary, Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"));
            }
            ...
            public async Task RequestsCorrectUrlMulti()
            {
                ...
                gitHubClient.Connection.Get<List<PullRequestReviewComment>>(firstPageUrl,
                    Arg.Is<Dictionary<string, string>>(d => d.Count == 3
                        ...
                        && d["sort"] == "updated"), Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"))
                    .Returns(Task.Factory.StartNew<IApiResponse<List<PullRequestReviewComment>>>(() => firstPageResponse));
            ...
            public async Task RequestsCorrectUrlWithoutSelectedSortingArgumentsMulti()
            {
                ...
                gitHubClient.Connection.Get<List<PullRequestReviewComment>>(firstPageUrl,
                    Arg.Is<Dictionary<string, string>>(d => d.Count == 2
                        && d["direction"] == "asc"
                        && d["sort"] == "created"), Arg.Is<string>(s => s == "application/vnd.github.squirrel-girl-preview"))
                    .Returns(Task.Factory.StartNew<IApiResponse<List<PullRequestReviewComment>>>(() => firstPageResponse));
