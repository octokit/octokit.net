...
namespace Octokit.Reactive
{
    public class ObservableOrganizationsClient : IObservableOrganizationsClient
    {
        ...
        public ObservableOrganizationsClient(IGitHubClient client)
        {
            ...
            OutsideCollaborators = new ObservableOrganizationOutsideCollaboratorsClient(client);
        ...
        /// </summary>
        public IObservableOrganizationOutsideCollaboratorsClient OutsideCollaborators { get; private set; }
