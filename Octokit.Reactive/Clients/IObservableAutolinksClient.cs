...
namespace Octokit.Reactive
{
    ...
    public interface IObservableAutolinksClient
    {
        ...
        IObservable<Autolink> Get(string owner, string repo, int autolinkId, CancellationToken cancellationToken = default);
        ...
        IObservable<Autolink> GetAll(string owner, string repo, CancellationToken cancellationToken = default);
        ...
        /// <remarks>See the <a href="https://docs.github.com/en/rest/repos/autolinks#list-all-autolinks-of-a-repository">API documentation</a> for more information.</remarks>
        IObservable<Autolink> GetAll(string owner, string repo, ApiOptions options, CancellationToken cancellationToken = default);
        ...
        IObservable<Autolink> Create(string owner, string repo, AutolinkRequest autolink, CancellationToken cancellationToken = default);
        ...
        IObservable<Unit> Delete(string owner, string repo, int autolinkId, CancellationToken cancellationToken = default);
    }
}
