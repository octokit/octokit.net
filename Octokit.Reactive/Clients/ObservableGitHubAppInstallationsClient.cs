...
namespace Octokit.Reactive
{
    ...
    public class ObservableGitHubAppInstallationsClient : IObservableGitHubAppInstallationsClient
    {
        ...
        {
            return _connection.GetAndFlattenAllPages<RepositoriesResponse>(ApiUrls.InstallationRepositories(), null, options);
        }
        ...
        {
            return _connection.GetAndFlattenAllPages<RepositoriesResponse>(ApiUrls.UserInstallationRepositories(installationId), null, options);
        }
    }
}