...
namespace Octokit.Reactive
{
    ...
    /// </remarks>
    public interface IObservableTeamDiscussionsClient
    {
        /// <summary>
        ...
        IObservable<TeamDiscussion> Get(int teamId, int number);
        ...
        /// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
        IObservable<TeamDiscussion> GetAll(int teamId);
        ...
        /// <returns>A list of discussions in the team.</returns>
        /// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
        IObservable<TeamDiscussion> GetAll(int teamId, ApiOptions options);
