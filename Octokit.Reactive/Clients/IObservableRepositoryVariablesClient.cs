...
namespace Octokit.Reactive
{
    ...
    public interface IObservableRepositoryVariablesClient
    {
        ...
        IObservable<RepositoryVariablesCollection> GetAllOrganization(string owner, string repoName, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
        /// <returns>A <see cref="RepositoryVariablesCollection"/> instance for the list of repository variables.</returns>
        IObservable<RepositoryVariablesCollection> GetAll(string owner, string repoName, CancellationToken cancellationToken = default);
        ...
        IObservable<RepositoryVariable> Get(string owner, string repoName, string variableName, CancellationToken cancellationToken = default);
        ...
        IObservable<RepositoryVariable> Create(string owner, string repoName, Variable newVariable, CancellationToken cancellationToken = default);
        ...
        IObservable<RepositoryVariable> Update(string owner, string repoName, Variable variable, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">An optional token to monitor for cancellation requests</param>
        /// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
        IObservable<Unit> Delete(string owner, string repoName, string variableName, CancellationToken cancellationToken = default);
    }
}
